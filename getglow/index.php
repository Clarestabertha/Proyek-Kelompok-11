...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item <?php echo ($currentPage == 'bnb.php') ? 'active' : ''; ?>" href="?page=bnb">Barenbliss</a></li>
        <li><a class="dropdown-item <?php echo ($currentPage == 'myb.php') ? 'active' : ''; ?>" href="?page=myb" >Maybelline</a></li>
        <li><a class="dropdown-item <?php echo ($currentPage == 'wrdh.php') ? 'active' : ''; ?>" href="?page=wrdh">Wardah</a></li>
    </ul>
</li>
<li class="nav-item <?php echo ($currentPage == 'topreview.php') ? 'active' : ''; ?>">
    <a class="nav-link" href="?page=topreview" >Review</a>
</li>
<li class="nav-item <?php echo ($currentPage == 'aboutus.php') ? 'active' : ''; ?>">
