...
<body>
    ...
    <div class="centered">
        <img src="img/logo wardah.png" width="400">
    </div>
    <br>
...
<div class="judul" id="com">
    ...
    <div class="row">
        ...
        WHERE p.jenis='Complexion' AND pb.id_brand='WRD' AND pb.tgl_launching IS NOT NULL";
...
<!--LIP PRODUCT-->
    ...
    <div class="row">
        ...
        $sql = "SELECT p.* FROM produk p
        JOIN produk_brand pb ON p.id_produk = pb.id_produk
        WHERE p.jenis='Lip Product' AND pb.id_brand='WRD' AND pb.tgl_launching IS NOT NULL";
        $query = mysqli_query($conn, $sql);
...
<div class="judul" id="eye">
    ...
    <div class="row">
        ...
        $sql = "SELECT p.* FROM produk p
        JOIN produk_brand pb ON p.id_produk = pb.id_produk
        WHERE p.jenis='Eye Makeup' AND pb.id_brand='WRD' AND pb.tgl_launching IS NOT NULL";
        $query = mysqli_query($conn, $sql);
...
<div class="judul" id="remov">
    ...
    <div class="row">
        ...
        $sql = "SELECT p.* FROM produk p
        JOIN produk_brand pb ON p.id_produk = pb.id_produk
        WHERE p.jenis='Remover' AND pb.id_brand='WRD' AND pb.tgl_launching IS NOT NULL";
        $query = mysqli_query($conn, $sql);
